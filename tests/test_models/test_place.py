...
class TestPlace(unittest.TestCase):
    ...
    def test_init_with_no_kwargs(self):
        ...
        self.assertEqual(type(instance1), Place)
        self.assertEqual(type(instance2), Place)
        ...
        self.assertEqual(type(instance1.city_id), str)
        self.assertEqual(type(instance1.user_id), str)
        self.assertEqual(type(instance1.name), str)
        self.assertEqual(type(instance1.description), str)
        self.assertEqual(type(instance1.number_rooms), int)
        self.assertEqual(type(instance1.number_bathrooms), int)
        self.assertEqual(type(instance1.max_guest), int)
        self.assertEqual(type(instance1.price_by_night), int)
        self.assertEqual(type(instance1.latitude), float)
        self.assertEqual(type(instance1.longitude), float)
        self.assertEqual(type(instance1.amenity_ids), list)
